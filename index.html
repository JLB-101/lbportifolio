...
* Template URL:https://github.com/JLB-101/lbportifolio
* Author: https://github.com/JLB-101
* Contact: +258 84 52 53 935
* Whatsapp: +258 84 52 53 935
* License: GPL3
 -->
...
<head>
  ...
  <title>DevFolio Feito em  Bootstrap - Portifolio de Juliao LB</title>
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="#work">Works</a></li>
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="hero-title mb-4">Eu sou Juliao LB  <a style="color: #0078ff;" href="https://github.com/JLB-101">#JLB-101</a></h1>
          <?php
          $teste = "Hello world";
              echo $teste;
          ?>
          <p class="hero-subtitle"><span class="typed" data-typed-items="Designer, desenvolvedor, Programador .java"></span></p>
  ...
  <main id="main">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="assets/img/JLB-101.jpg" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Nome: </span> <span>Juliao Langassitela Bauaze</span></p>
                        <p><span class="title-s">Perfil: </span> <span>full stack developer</span></p>
                        <p><span class="title-s">Email: </span> <span><a href="mailto:juliaolangassitela@gmail.com">juliaolangassitela@gmail.com</a></span></p>
                        <p><span class="title-s">Tell: </span> <span> <a href="tel:+258845253935">+258 84 52 53 935</a> </span></p>
                        <p><span class="title-s">Gitname: </span> <span><a href="https://github.com/JLB-101">#JLB-101</a></h1></span></p>
                      </div>
                    </div>
                  </div>
                  <div class="skill-mf">
                    <p class="title-s">Skill - minhas habilidades</p>
                    <span>HTML</span> <span class="pull-right">45%</span>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width: 45%;" aria-valuenow="45%" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span>CSS3</span> <span class="pull-right">35%</span>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width: 35%" aria-valuenow="35%" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span>JAVA</span> <span class="pull-right">69%</span>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width: 69%;" aria-valuenow="69%" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span>PHP</span> <span class="pull-right">47%</span>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width: 47%" aria-valuenow="47%" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span>Python</span> <span class="pull-right">31%</span>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width: 31%" aria-valuenow="31%" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span>C#</span> <span class="pull-right">53%</span>
                    <div class="progress">
    ...
    </section><!-- Fim Sessao de Contacto -->
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box">
            <p class="copyright">&copy; Copyright <strong>DevFolio</strong>. Todos direitos reservados</p>
            <div class="credits"> 
              Designed by <a href="https://github.com/JLB-101/">JLB-101</a>
            </div>
          </div>
        </div>
      </div>
